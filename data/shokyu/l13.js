...
JPD.lesson({
  ...
  vocab: [
    ...
    { g: '私の経験から', w: 'サービス', k: '', m: 'Service (Dịch vụ)' },
    { g: '私の経験から', w: '相撲', k: 'すもう', m: 'Vật Sumo' },
    { g: '私の経験から', w: 'ホテル', k: '', m: 'Hotel (Khách sạn)' },
    ...
    { g: 'おすすめします', w: 'ジェットコースター', k: '', m: 'Jet coaster (Tàu lượn)' },
    { g: 'おすすめします', w: '電気製品', k: 'でんきせいひん', m: 'Đồ điện' },
    { g: 'おすすめします', w: 'サングラス', k: '', m: 'Sunglasses (Kính mát)' },
    { g: 'おすすめします', w: '眼鏡', k: 'めがね', m: 'Kính' },
    { g: 'おすすめします', w: 'シャツ', k: '', m: 'Shirt (Áo sơ mi)' },
    { g: 'おすすめします', w: 'スカート', k: '', m: 'Skirt (Váy (ngắn), juýp)' },
    { g: 'おすすめします', w: 'ネクタイ', k: '', m: 'Necktie (Cà vạt)' },
    ...
    { g: '教えてください', w: 'バスケットボール', k: '', m: 'Basketball (Bóng rổ)' },
  ...
  exam: [
    { sec: 'Ngữ pháp', t: 'mcq', q: '相撲を＿＿＿。', opt: ['見たことがあります', '見たことです', '見ることがあります', '見たいです'], ans: 0 },
    { sec: 'Ngữ pháp', t: 'mcq', q: '日本へ＿＿＿、相撲が好きになりました。', opt: ['来てから', '来る前に', '来たことがあります', '来ています'], ans: 0 },
    { sec: 'Ngữ pháp', t: 'mcq', q: '寝る＿＿＿、歯を磨きます。', opt: ['前に', 'てから', 'ことがあります', 'ています'], ans: 0 },
    { sec: 'Ngữ pháp', t: 'mcq', q: 'A：あの店を知っていますか。 B：いいえ、＿＿＿。', opt: ['知りません', '知っていません', '知りませんでした', '知っていましたか'], ans: 0 },
    { sec: 'Ngữ pháp', t: 'mcq', q: '赤いシャツを＿＿＿人です。', opt: ['着ている', '着った', '着るの', '着ます'], ans: 0 },
    { sec: 'Điền từ', t: 'fill', q: '「浴衣」＿＿＿服を知っていますか。', acc: ['という'] },
    { sec: 'Điền từ', t: 'fill', q: '母＿＿＿作った料理を食べました。', acc: ['が'] },
    { sec: 'Đọc hiểu', t: 'reading', passage: 'リンさん：これ、可愛いですね。どこで買いましたか。\nソンさん：これは去年、京都で買った帽子です。私が行った店には、若い人に人気の帽子がたくさんありました。\nリンさん：いいですね。私も京都へ行ったことがありますが、そのお店を知りませんでした。\nソンさん：今度、一緒に行きましょう。', qs: [
      { q: 'ソンさんの帽子はどこで買いましたか。', opt: ['京都の店', '東京の店', 'ネットショップ', 'デパート'], ans: 0 },
      { q: 'リンさんは京都へ行ったことがありますか。', opt: ['はい、あります', 'いいえ、ありません', 'わかりません', '今度行きます'], ans: 0 }
    ] }
  ],
