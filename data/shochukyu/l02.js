...
JPD.lesson({
  id: 'shochukyu-2', n: 2, jp: '楽しいショッピング', vi: 'Mua sắm vui vẻ',
    ...
    { g: '上手に買い物', w: 'セーター', k: '', m: 'Sweater (Áo len)' },
    { g: '上手に買い物', w: 'スーツケース', k: '', m: 'Suitcase (Va li)' },
    { g: '上手に買い物', w: 'コート', k: '', m: 'Coat (Áo khoác)' },
    { g: '上手に買い物', w: '棚', k: 'たな', m: 'Cái giá' },
    { g: '上手に買い物', w: '指輪', k: 'ゆびわ', m: 'Cái nhẫn' },
    { g: '上手に買い物', w: 'サイズ', k: '', m: 'Size (Kích cỡ)' },
    { g: '上手に買い物', w: '数字', k: 'すうじ', m: 'Số' },
    { g: '上手に買い物', w: '取っ手', k: 'とって', m: 'Tay cầm, quai' },
    { g: '上手に買い物', w: 'ヒール', k: '', m: 'Heel (Gót giày)' },
    { g: '上手に買い物', w: 'ファスナー', k: '', m: 'Fastener (Khóa kéo)' },
    { g: '上手に買い物', w: 'ボタン', k: '', m: 'Button (Khuy)' },
    { g: '上手に買い物', w: 'ジーンズ', k: '', m: 'Jeans (Quần bò)' },
    { g: '上手に買い物', w: '売り場', k: 'うりば', m: 'Nơi bán hàng' },
    { g: '上手に買い物', w: '動く', k: 'うごく', m: 'Cử động, di chuyển' },
    { g: '上手に買い物', w: '違う', k: 'ちがう', m: 'Khác, sai' },
    { g: '上手に買い物', w: 'イメージ（する）', k: '', m: 'Image (Hình dung, ấn tượng)' },
    ...
    { g: '一緒に食事', w: 'サンドイッチ', k: '', m: 'Sandwich (Bánh sandwich)' },
    { g: '一緒に食事', w: 'ソース', k: '', m: 'Sauce (Nước sốt)' },
    { g: '一緒に食事', w: 'セット', k: '', m: 'Set (Bộ, set)' },
    { g: '一緒に食事', w: 'ドリンクバー', k: '', m: 'Drink bar (Quầy nước uống tự chọn)' },
    { g: '一緒に食事', w: '壁', k: 'かべ', m: 'Bức tường' },
    { g: '一緒に食事', w: 'カレンダー', k: '', m: 'Calendar (Lịch)' },
    { g: '一緒に食事', w: '期間限定', k: 'きかんげんてい', m: 'Chỉ có trong một khoảng thời gian' },
    { g: '一緒に食事', w: '最新', k: 'さいしん', m: 'Gần đây, mới nhất' },
    { g: '一緒に食事', w: '商品', k: 'しょうひん', m: 'Sản phẩm, hàng hóa' },
    { g: '一緒に食事', w: '世界地図', k: 'せかいちず', m: 'Bản đồ thế giới' },
    { g: '一緒に食事', w: '送料', k: 'そうりょう', m: 'Tiền vận chuyển' },
    { g: '一緒に食事', w: 'タイムサービス', k: '', m: 'Time service (Khuyến mãi theo giờ)' },
    { g: '一緒に食事', w: '半額', k: 'はんがく', m: 'Một nửa số tiền' },
    { g: '一緒に食事', w: 'フロアガイド', k: '', m: 'Floor guide (Bảng hướng dẫn các tầng)' },
    { g: '一緒に食事', w: '本日', k: 'ほんじつ', m: 'Ngày hôm nay' },
    { g: '一緒に食事', w: '量', k: 'りょう', m: 'Lượng' },
    { g: '一緒に食事', w: '～券（例：割引券）', k: '～けん（れい：わりびきけん）', m: 'Phiếu ~ (ví dụ: phiếu giảm giá)' },
    { g: '一緒に食事', w: '～放題（例：飲み放題）', k: '～ほうだい（れい：のみほうだい）', m: '~ thoải mái (ví dụ: uống thoải mái)' },
    ...
    { g: '一緒に食事', w: 'レディースデー', k: '', m: 'Ladies\' Day (Ngày Phụ nữ)' },

    { g: 'もう一度聞こう', w: '大変', k: 'たいへん', m: 'Vất vả, rất là' },
    { g: 'もう一度聞こう', w: 'デザート', k: '', m: 'Dessert (Đồ tráng miệng)' }
  ],
  ...
  grammar: [
    ...
    { c: '服', m: 'PHỤC — quần áo', on: 'フク', kun: '',
      w: [{ jp: '服', k: 'ふく', vi: 'quần áo' }, { jp: '洋服', k: 'ようふく', vi: 'quần áo kiểu Tây' }] },
    { c: '品', m: 'PHẨM — đồ vật, hàng hóa', on: 'ヒン', kun: 'しな',
      w: [{ jp: '食料品', k: 'しょくりょうひん', vi: 'thực phẩm' }, { jp: '返品', k: 'へんぴん', vi: 'hàng trả lại' },
          { jp: '品物', k: 'しなもの', vi: 'hàng hóa, đồ vật' }, { jp: '用品', k: 'ようひん', vi: 'đồ dùng' }] },
    { c: '電', m: 'ĐIỆN — điện', on: 'デン', kun: '',
      w: [{ jp: '電気', k: 'でんき', vi: 'điện' }, { jp: '電子辞書', k: 'でんしじしょ', vi: 'từ điển điện tử' }] },
    { c: '別', m: 'BIỆT — khác, riêng', on: 'ベツ', kun: 'わか・れる',
      w: [{ jp: '別', k: 'べつ', vi: 'khác, riêng' }, { jp: '別れる', k: 'わかれる', vi: 'chia tay, tách ra' },
          { jp: '特別', k: 'とくべつ', vi: 'đặc biệt' }] },
    { c: '引', m: 'DẪN — kéo; trừ', on: 'イン', kun: 'ひ・く',
      w: [{ jp: '引く', k: 'ひく', vi: 'kéo; trừ' }, { jp: '～引き', k: '～びき', vi: 'giảm ～' },
          { jp: '割引', k: 'わりびき', vi: 'giảm giá' }] },
    { c: '送', m: 'TỐNG — gửi', on: 'ソウ', kun: 'おく・る',
      w: [{ jp: '送る', k: 'おくる', vi: 'gửi' }, { jp: '送料', k: 'そうりょう', vi: 'phí vận chuyển' },
          { jp: '転送', k: 'てんそう', vi: 'chuyển tiếp' }, { jp: '送信', k: 'そうしん', vi: 'gửi, truyền đi' }] },
    { c: '切', m: 'THIẾT — cắt', on: 'セツ、サイ', kun: 'き・る',
      w: [{ jp: '切る', k: 'きる', vi: 'cắt' }, { jp: '売り切れ', k: 'うりきれ', vi: 'bán hết' },
          { jp: '品切れ', k: 'しなぎれ', vi: 'hết hàng' }, { jp: '大切', k: 'たいせつ', vi: 'quan trọng, quý giá' }] },
    { c: '安', m: 'AN — rẻ; an tâm', on: 'アン', kun: 'やす・い',
      w: [{ jp: '安い', k: 'やすい', vi: 'rẻ' }, { jp: '不安', k: 'ふあん', vi: 'bất an, lo lắng' },
          { jp: '安心', k: 'あんしん', vi: 'yên tâm' }] },
    { c: '開', m: 'KHAI — mở', on: 'カイ', kun: 'あ・く、ひら・く、あ・ける',
      w: [{ jp: '開く', k: 'あく', vi: 'mở' }, { jp: '開く', k: 'ひらく', vi: 'mở' },
          { jp: '開ける', k: 'あける', vi: 'mở' }, { jp: '開始', k: 'かいし', vi: 'bắt đầu' }] },
    { c: '閉', m: 'BẾ — đóng', on: 'ヘイ', kun: 'し・まる、し・める',
      w: [{ jp: '閉まる', k: 'しまる', vi: 'đóng lại' }, { jp: '閉める', k: 'しめる', vi: 'đóng' },
          { jp: '開閉', k: 'かいへい', vi: 'đóng mở' }] },
    { c: '払', m: 'PHẤT — trả (tiền)', on: 'フツ', kun: 'はら・う',
      w: [{ jp: '払う', k: 'はらう', vi: 'trả tiền' }] },
    { c: '返', m: 'PHẢN — trả lại', on: 'ヘン', kun: 'かえ・す',
      w: [{ jp: '返品', k: 'へんぴん', vi: 'hàng trả lại' }] },
    { c: '無', m: 'VÔ — không có', on: 'ム、ブ', kun: 'な・い',
      w: [{ jp: '無料', k: 'むりょう', vi: 'miễn phí' }] },
    { c: '価', m: 'GIÁ — giá cả', on: 'カ', kun: 'あたい',
      w: [{ jp: '価格', k: 'かかく', vi: 'giá cả' }] },
    { c: '税', m: 'THUẾ — thuế', on: 'ゼイ', kun: '',
      w: [{ jp: '税', k: 'ぜい', vi: 'thuế' }, { jp: '税込', k: 'ぜいこみ', vi: 'đã bao gồm thuế' }] },
    { c: '込', m: 'VÀO — bao gồm, dồn vào', on: '', kun: 'こ・む',
      w: [{ jp: '税込', k: 'ぜいこみ', vi: 'đã bao gồm thuế' }] }
  ]
});
