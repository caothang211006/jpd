...
JPD.lesson({
  ...
  vocab: [
    ...
    { g: '話読聞書', w: 'ポスター', k: '', m: 'Poster (Áp phích quảng cáo)' },
    ...
    { g: '発表の準備', w: 'レコード', k: '', m: 'Record (Máy ghi âm, đĩa nhạc)' },
    ...
    { g: '発表の準備', w: 'グラフ', k: '', m: 'Graph (Biểu đồ)' },
    ...
    { g: 'みんなの前で発表', w: 'クッキー', k: '', m: 'Cookie (Bánh quy)' },
    { g: 'みんなの前で発表', w: '輸出（する）', k: 'ゆしゅつ', m: 'Xuất khẩu' },
    { g: 'みんなの前で発表', w: 'インフルエンザ', k: '', m: 'Influenza (Cảm cúm)' },
