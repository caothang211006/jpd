...
JPD.lesson({
  ...
  vocab: [
    ...
    { g: '初めての訪問', w: 'ミステリー', k: '', m: 'Mystery (Huyền bí, bí ẩn)' },
    ...
    { g: '一緒に作りましょう', w: 'キャベツ', k: '', m: 'Kool (Bắp cải)' },
    ...
    { g: '一緒に作りましょう', w: 'カップ', k: '', m: 'Cup (Cái chén, cốc)' },
    { g: '一緒に作りましょう', w: 'クリーム', k: '', m: 'Cream (Kem)' },
    { g: '一緒に作りましょう', w: 'ゼリー', k: '', m: 'Jelly (Thạch)' },
    { g: '一緒に作りましょう', w: 'ソース', k: '', m: 'Sauce (Nước sốt)' },
    { g: '一緒に作りましょう', w: 'パスタ', k: '', m: 'Pasta (Mỳ Ý)' },
    ...
    { g: '一緒に作りましょう', w: 'ルー', k: '', m: 'Roux (Nước sốt kiểu Pháp (roux))' },
    { g: '一緒に作りましょう', w: 'グラム', k: '', m: 'Gram (Gram)' },
