...
JPD.lesson({
  ...
  vocab: [
    { g: '話読聞書', w: 'インスタント', k: '', m: 'Instant (Ăn liền, tức thời)' },
    ...
    { g: '体調不良', w: 'ジム', k: '', m: 'Gym (Phòng tập thể hình)' },
    { g: '体調不良', w: '氷', k: 'こおり', m: 'Đá' },
    { g: '体調不良', w: 'ドレッシング', k: '', m: 'Dressing (Nước sốt (salad dressing))' },
    ...
    { g: '毎日、元気に！', w: 'バランス', k: '', m: 'Balance (Sự cân bằng)' },
    ...
    { g: 'もう一度聞こう', w: 'グレープフルーツ', k: '', m: 'Grapefruit (Bưởi)' },
