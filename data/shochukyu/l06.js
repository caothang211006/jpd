...
JPD.lesson({
  ...
  vocab: [
    ...
    { g: '話読聞書', w: 'カヌー', k: '', m: 'Canoe (Ca nô)' },
    { g: '話読聞書', w: '楽しむ', k: 'たのしむ', m: 'Tận hưởng, vui vẻ' },

    { g: '旅行の計画', w: 'カニ', k: '', m: 'Cua' },
    { g: '旅行の計画', w: '着物', k: 'きもの', m: 'Kimono' },
    { g: '旅行の計画', w: 'ショッピングセンター', k: '', m: 'Shopping center (Trung tâm mua sắm)' },
    { g: '旅行の計画', w: '水族館', k: 'すいぞくかん', m: 'Thủy cung' },
    { g: '旅行の計画', w: 'スノーボード', k: '', m: 'Snowboard (Ván trượt tuyết)' },
    ...
    { g: '旅行の準備', w: 'ショー', k: '', m: 'Show (Buổi biểu diễn)' },
    { g: '旅行の準備', w: '手袋', k: 'てぶくろ', m: 'Găng tay, bao tay' },
    { g: '旅行の準備', w: 'マフラー', k: '', m: 'Muffler (Khăn choàng cổ)' },
    { g: '旅行の準備', w: '年末', k: 'ねんまつ', m: 'Cuối năm' },
    { g: '旅行の準備', w: 'ガイドブック', k: '', m: 'Guidebook (Sách hướng dẫn)' },
    { g: '旅行の準備', w: 'パーク', k: '', m: 'Park (Công viên)' },
